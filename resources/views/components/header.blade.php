        ...
        <div class="flex items-center justify-between h-16">
           ...
           flex items-center space-x-2 px-3 py-2 rounded-md text-sm font-medium">
                  ...
                  text-text-secondary-light dark:text-text-secondary-dark bg-gray-100 dark:bg-gray-700">
                            ...
                            {{-- Tooltip --}}
                            <span
                                class="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 bg-gray-800 text-white text-xs rounded py-1 px-2 opacity-0 
            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="relative hidden md:block">
                    <button id="userMenuButton"
                        ...
                        type="button">
                        <span
                            class="material-icons text-text-secondary-light dark:text-text-secondary-dark">person</span>
                    </button>
                    <!-- Dropdown user -->
