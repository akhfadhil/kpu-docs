                    ...
                    <table class="w-full">
                        <tbody class="divide-y divide-border-light dark:divide-border-dark">
                            <tr class="divide-x divide-border-light dark:divide-border-dark">
                                <td
                                    class="px-4 py-3 font-medium text-text-secondary-light dark:text-text-secondary-dark w-1/3">
                                    Alamat</td>
                            ...
                            <tr class="divide-x divide-border-light dark:divide-border-dark">
                                <td
                                    class="px-4 py-3 font-medium text-text-secondary-light dark:text-text-secondary-dark w-1/3">
                                    Jumlah Pemilih</td>
                                <td class="px-4 py-3 text-text-light dark:text-text-dark">{{ $tps->number_of_voters }}
                                </td>
                            </tr>
                            <tr class="divide-x divide-border-light dark:divide-border-dark">
                                <td
                                    class="px-4 py-3 font-medium text-text-secondary-light dark:text-text-secondary-dark w-1/3">
                                    Ketua KPPS</td>
                                <td class="px-4 py-3 text-text-light dark:text-text-dark">{{ $tps->ketua_kpps->name }}
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
                    ...
                    @foreach ($docs as $title => $filename)
                        ...
                        <div
                            class="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg flex flex-col items-center text-center">
                            ...
                            @if ($exists)
                                <button data-modal-target="pdfModal" data-modal-toggle="pdfModal"
                                    data-pdf="{{ asset($path) }}"
                                    class="pdf-view-btn w-full bg-primary/10 text-primary hover:bg-primary/20 font-medium py-2 px-4 rounded-lg text-sm transition duration-150 ease-in-out">
                                    Lihat Dokumen
                                </button>
                            @else
                                <button disabled
                ...
                <div class="flex justify-between items-center mb-4">
                    <div>
                        ...
                        <p class="text-sm text-text-secondary-light dark:text-text-secondary-dark mt-1">Daftar semua
                            anggota KPPS di TPS ini, termasuk nama dan jabatannya.</p>
                    </div>
