...
<html lang="en">
   <head>
      ...
      <title>TPS-1-Bangorejo Details</title>
   ...
   <body class="font-display bg-background-light dark:bg-background-dark text-text-light dark:text-text-dark">
      <div class="min-h-screen flex flex-col">
        {{-- header --}}
         <header class="bg-card-light dark:bg-card-dark shadow-md">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
               <div class="flex items-center justify-between h-16">
                  <div class="flex items-center space-x-8">
                     <div class="flex-shrink-0 flex items-center space-x-2">
                        <img alt="Logo" class="h-8 w-auto" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBCUqT4zwttEMPS8TNTED5LDGlZWychhat8sfEneU3u0yU33n1VcQTFqg6bh6Iou1BEzziIvZ7IwUe4QRbWB5zDEea_QPDRusOjFpZFxS-M40I3U9h3ip7a5guPQWSuPFTHYpZ78FIo0128I2qwymnqi8KvPRG424ltLwduSARoysvE9fyIKddpi_eJvPdohvdQ6Mlmzl_hYj5PrxyPVRq1pb1Cq0m4MIJJR49gJJY6VCkKyOYCGr0BIvgcfZTun8CagC7qtxK6IBcw"/>
                        <span class="text-xl font-bold">PemiluApp</span>
                     </div>
                     <nav class="hidden md:flex space-x-4">
                        <a class="flex items-center space-x-2 bg-primary/10 text-primary px-3 py-2 rounded-md text-sm font-medium" href="#">
                        <span class="material-icons text-base">dashboard</span>
                        <span>Dashboard</span>
                        </a>
                        <a class="flex items-center space-x-2 text-text-secondary-light dark:text-text-secondary-dark hover:bg-gray-100 dark:hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium" href="#">
                  ...
                  <div class="flex items-center">
                     <button class="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary" type="button">
         ...
         <main class="flex-grow">
            <div class="bg-gray-800 dark:bg-gray-900 shadow-inner">
               <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
                  <h1 class="text-3xl font-bold text-white">TPS-1-Bangorejo</h1>
               </div>
            </div>
         ...
         <footer class="bg-card-light dark:bg-card-dark mt-12">
            <div class="container mx-auto py-4 px-4 sm:px-6 lg:px-8">
               <p class="text-center text-sm text-text-secondary-light dark:text-text-secondary-dark">© 2023 PemiluApp. All rights reserved.</p>
            </div>
         </footer>
      </div>
   </body>
