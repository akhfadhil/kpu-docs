    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <p class="mt-2 text-center text-sm text-gray-400">
                Anda menggunakan password sementara.<br>
                Silakan ubah demi keamanan akun Anda.
            </p>
        </div>
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <form method="POST" action="{{ route('password.force_change.update') }}" class="space-y-6">
                ...
                <!-- Password Baru -->
                <div>
                    <label for="new_password" class="block text-sm font-medium text-gray-100">
                        Password Baru
                    </label>
                ...
                <!-- Konfirmasi Password -->
                <div>
                    <label for="new_password_confirmation" class="block text-sm font-medium text-gray-100">
                        Konfirmasi Password
                    </label>
                ...
                ? `<svg xmlns="http://www.w3.org/2000/svg" fill="none"
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round"
                              d="M3.98 8.223A10.477 10.477 0 001.934 12
                                 C3.226 16.44 7.244 19.5 12 19.5
                                 c1.73 0 3.37-.376 4.819-1.047
